...
<form class="flex flex-col justify-between items-center w-full p-4 bg-white rounded-xl gap-4" method="POST" action="?/login">
    {#if form?.notVerified}
    ...
    <button
        ...
        on:click={validate} disabled={ !validateEmail(email)}>Sign in</button
    >
</form>
</div>
